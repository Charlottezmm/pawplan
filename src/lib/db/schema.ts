...
export const timeBlockKind = pgEnum("time_block_kind", ["course", "exam", "meeting", "unavailable", "routine", "recovery"]);
...
export const timeBlockExceptions = pgTable("time_block_exceptions", {
  ...
  overrideLocation: varchar("override_location", { length: 240 }),
  overrideLocationSet: boolean("override_location_set").notNull().default(false),
